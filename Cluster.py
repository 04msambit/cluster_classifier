...
def bing_search_clustering(fileName):
    ...
    for n in range(0,input_range):
        ...
        #mini_cluster.append(document_list[rand_val])
        id_list.append(rand_val)
    ...
    print 'The Clusters have converged and we will print the clusters now :\n'
    ...
    print '\nThe RI[Rand_Index] value for k value ',
    print input_range,
    print ' is ',
    print rand_index
    print '\n'
